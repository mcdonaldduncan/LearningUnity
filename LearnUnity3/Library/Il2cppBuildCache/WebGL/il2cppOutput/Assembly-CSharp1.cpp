...
IL_0102:
	{
		...
		VirtActionInvoker1< String_t* >::Invoke(64 /* System.Void TMPro.TMP_Text::set_text(System.String) */, L_25, L_26);
...
IL_0092:
	...
	}
	{
		...
		VirtActionInvoker1< int32_t >::Invoke(106 /* System.Void TMPro.TMP_Text::UpdateVertexData(TMPro.TMP_VertexDataUpdateFlags) */, L_48, ((int32_t)16));
	}
...
IL_03ec:
	{
		...
		int32_t L_191 = V_12;
		VirtActionInvoker2< Mesh_t2F5992DBA650D5862B43D3823ACD997132A57DA6 *, int32_t >::Invoke(105 /* System.Void TMPro.TMP_Text::UpdateGeometry(UnityEngine.Mesh,System.Int32) */, L_186, L_190, L_191);
		// for (int i = 0; i < textInfo.meshInfo.Length; i++)
		int32_t L_192 = V_12;
...
IL_0455:
	{
		...
		int32_t L_238 = V_16;
		VirtActionInvoker2< Mesh_t2F5992DBA650D5862B43D3823ACD997132A57DA6 *, int32_t >::Invoke(105 /* System.Void TMPro.TMP_Text::UpdateGeometry(UnityEngine.Mesh,System.Int32) */, L_233, L_237, L_238);
		// for (int i = 0; i < textInfo.meshInfo.Length; i++)
		int32_t L_239 = V_16;
